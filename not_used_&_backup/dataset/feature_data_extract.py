...
class Feature(Enum):
    ...
    # ----Feature Weaknesses of Teams / Team Composition----# NOT USED
...
class FeatureRegistry:
    ...
    def _register_all_extractors(self):
        ...
        # self._extractors[Feature.OFFENSE_SPEED_PRODUCT] = fbs.atk_spe_prod  #NOT USED
        ...
        self._extractors[Feature.MEAN_HP_DIFFERENCE_START] = (
            fbs.mean_hp_difference_start
        )
        ...
        self._extractors[Feature.FINAL_TEAM_HP_DIFFERENCE] = (
            fbs.final_team_hp_difference
        )
        ...
        self._extractors[Feature.STATUS_INFLICTED_DIFFERENCE] = (
            fdb.status_inflicted_difference
        )
