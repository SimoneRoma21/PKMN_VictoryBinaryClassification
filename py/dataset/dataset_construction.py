...
class FeaturePipeline:
    ...
    def __init__(
        self, features: List[Feature], cache_dir: str = "../data/feature_cache"
    ):
        """
    ...
    def extract_features(
        ...
        df_dict = {"battle_id": [battle.get("battle_id") for battle in data]}
        ...
        iterator = (
            tqdm(self.features, desc="Extracting features")
            if show_progress
            else self.features
        )
