...
def weakness_teams(dataset) ->pd.DataFrame: #feature 
    ...
    for game in dataset:
            ...
            weak_games_p1.append(len(sw_1)) #append the len of the set (no duplicate weaknesses)
            ...
            weak_games_p2.append(len(sw_2)) #append the len of the set (no duplicate weaknesses)
