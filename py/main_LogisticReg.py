...
def evaluate_test_set(trainer: ModelTrainer, feature_list: list, test_file_path: str):
    ...
    submission.to_csv("predict_csv/predictions_LogisticReg.csv", index=False)


if __name__ == "__main__":
    main()

    # Best params obtained : {'classifier__C': 1, 'classifier__max_iter': 2000, 'classifier__penalty': 'l1', 'classifier__solver': 'saga'}
